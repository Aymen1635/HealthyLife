      ...
      child: InkWell(
        ...
        child: Container(
          decoration: BoxDecoration(
            color: AppTheme.darkGrey.withOpacity(0.07),
          ...
          child: Row(
            ...
            children: [
              CircleAvatar(
                ...
                child: Text(
                  ...
                  style: const TextStyle(
                      fontSize: 15, color: AppTheme.nearlyWhite),
                    ...
                    Padding(
                      ...
                      child: Text(foods![index].name!,
                          style: AppTheme.title
                              .copyWith(fontFamily: AppTheme.fontName),
              ...
              const Icon(Icons.add, color: AppTheme.nearlyDarkBlue)
            ],
          ),
        ),
      ),
