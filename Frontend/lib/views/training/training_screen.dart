          ...
          onPressed: () {
            AwesomeDialog(
              ...
              body: Column(
                children: [
                  Text(
                    'Current Step Count: ${widget.user.step}n'
                    'nEnter the number of steps you want to add.',
              ...
              btnOkOnPress: () {
                ...
                AwesomeDialog(
                  ...
                  title: 'My Steps Added',
                  desc: 'My steos has been added successfully.',
                  btnOkOnPress: () {},
                ).show();
              },
            ).show();
